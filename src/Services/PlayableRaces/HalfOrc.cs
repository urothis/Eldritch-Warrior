...
namespace Services.PlayableRaces
{
    public class HalfOrc : IRace
    {
        ...
        public HalfOrc(ModuleEvents.OnClientEnter obj)
        {
            switch (obj.Player.SubRace)
            {
                case "Gray Orc": GrayOrc(obj); break;
            }
        }

        private void GrayOrc(ModuleEvents.OnClientEnter obj)
        {
            MaxLevel = 59;
            Hair = 63;
            Skin = 56;
            ...
            ModifyWisdom = 2;
            ModifyCharisma = -2;
            FavoredClasses?.Add(ClassType.Cleric);
        }
